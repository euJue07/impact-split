"""Tests for ImpactSplitter with strict NumPy API and spec-aligned recursion."""
...
def test_fit_requires_numpy_inputs() -> None:
    model = ImpactSplitter()

    with pytest.raises(ValueError, match="X must be a numpy.ndarray"):
